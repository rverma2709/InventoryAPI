...
namespace Root.Models.StoredProcedures
{
    ...
    public static class SqlParameterExtensions
    {
        ...
        public static string GetStoredProcedureName(object obj)
        {
        ...
        public static List<SqlParameter> ToSqlParamsList(object obj, SqlParameter[] additionalParams = null)
        {
            var props = (
        ...
        public static void ToObject(object obj, List<SqlParameter> sqlParameters = null)
        {
